...
create table horsemeat_sessions
(
...
create trigger horsemeat_sessions_set_updated_column
before update
on horsemeat_sessions
for each row
execute procedure set_updated_column();
...
create trigger horsemeat_session_data_set_updated_column
before update
on horsemeat_session_data
for each row
execute procedure set_updated_column();
